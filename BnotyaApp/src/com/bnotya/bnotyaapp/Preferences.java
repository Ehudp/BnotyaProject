        ...
        OnSharedPreferenceChangeListener
{
    ...
    private void onCreatePreferenceActivity()
    {
        ...
        // Get widgets
        _preferenceScreen = getPreferenceScreen();
        _timePref = (TimePreference)
                findPreference(getString(R.string.notification_time_preference));
        _seekBarPref = (SeekBarPreference)
                findPreference(getString(R.string.music_volume_preference));
    ...
    public static class AppPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(final Bundle savedInstanceState)
        {
            ...
            addPreferencesFromResource(R.xml.modern_prefs);

            Preferences activity = (Preferences) getActivity();
            // Get widgets
            activity._preferenceScreen = getPreferenceScreen();
            activity._timePref = (TimePreference)
                    findPreference(getString(R.string.notification_time_preference));
            activity._seekBarPref = (SeekBarPreference)
                    findPreference(getString(R.string.music_volume_preference));

            activity.initUserName();
            activity.setTimePickerSummary();
            activity.initMusicVolume();
        }
    }
    ...
    {
        boolean hasNotification = _preferenceScreen.getSharedPreferences()
                .getBoolean(key, true);
        if (hasNotification)
        {
    ...
    {
        boolean hasMusic = _preferenceScreen.getSharedPreferences()
                .getBoolean(key, true);
        if (hasMusic)
        {
    ...
    {
        super.onResume();
        _preferenceScreen.getSharedPreferences()
